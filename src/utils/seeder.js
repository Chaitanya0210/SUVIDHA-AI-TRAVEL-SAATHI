...
// Pre-seeded Indian destinations list with structured recommendation fields & ₹ INR costs
const initialDestinations = [
  {
    ...
    suitableFor: ["Solo", "Couple", "Family", "Senior Citizens", "Friends"],
    foodOptions: ["Pure Veg", "Jain", "Street Food", "Local Dhaba"],
    averageLocalTransportCostInr: 400,
    popularityScore: 95,
  ...
  },
  {
    ...
    foodOptions: ["Pure Veg", "Non-Veg", "Street Food", "Local Dhaba"],
    averageLocalTransportCostInr: 600,
    popularityScore: 92,
  ...
  },
  {
    ...
    suitableFor: ["Solo", "Couple", "Family", "Senior Citizens", "Friends"],
    foodOptions: ["Pure Veg", "Jain", "Local Dhaba", "Street Food"],
    averageLocalTransportCostInr: 500,
    popularityScore: 90,
  ...
  },
  {
    ...
    foodOptions: ["Non-Veg", "Pure Veg", "Street Food"],
    averageLocalTransportCostInr: 700,
    popularityScore: 96,
    bestSeasons: ["Winter", "Autumn"],
    idealDurationDays: 5,
    rating: 4.7,
  ...
  },
  {
    ...
    suitableFor: ["Couple", "Family", "Senior Citizens"],
    foodOptions: ["Non-Veg", "Pure Veg", "Local Dhaba"],
    averageLocalTransportCostInr: 600,
    popularityScore: 91,
  ...
  },
  {
    ...
    foodOptions: ["Pure Veg", "Non-Veg", "Local Dhaba"],
    averageLocalTransportCostInr: 1200,
    popularityScore: 89,
    bestSeasons: ["Summer"],
    idealDurationDays: 7,
    rating: 4.9,
  ...
  },
  {
    ...
    foodOptions: ["Pure Veg", "Jain", "Street Food", "Local Dhaba"],
    averageLocalTransportCostInr: 350,
    popularityScore: 93,
  ...
  },
  {
    ...
    suitableFor: ["Solo", "Couple", "Family", "Senior Citizens", "Friends"],
    foodOptions: ["Pure Veg", "Jain", "Local Dhaba", "Street Food"],
    averageLocalTransportCostInr: 300,
    popularityScore: 94,
    bestSeasons: ["Winter", "Autumn"],
    idealDurationDays: 2,
    rating: 4.9,
...
const seedDatabase = async (force = false) => {
  try {
    ...
    if (count === 0 || force) {
      ...
      console.log(`✅ Seeded ${initialDestinations.length} Indian destinations with structured recommendation fields.`);
    } else {
